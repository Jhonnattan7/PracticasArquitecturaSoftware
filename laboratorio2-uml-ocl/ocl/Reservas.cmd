...
!set e1.nombre := 'Ana Estudiante'-- =========================-- 2) Crear disponibilidades (para la regla 4)-- =========================
...
!insert (t1, d2) into TutorDisponibilidad-- =========================-- 3) Crear una reserva válida-- =========================
!create r1 : Reserva
!set r1.fechaHora := '2026-01-20T10:00'
!set r1.estado := #CONFIRMADA
!insert (t1, r1) into TutorReserva
!insert (e1, r1) into EstudianteReserva-- =========================-- 4) Crear una reserva duplicada (misma fechaHora) para violar la regla 3-- =========================
!create r2 : Reserva
!set r2.fechaHora := '2026-01-20T10:00'
!set r2.estado := #CREADA
!insert (t1, r2) into TutorReserva
!insert (e1, r2) into EstudianteReserva-- =========================-- 5) Crear una reserva con estado "sin asignar" para provocar problemas-- (En algunos entornos queda undefined y puede romper EstadoValido)-- =========================
!create r3 : Reserva
